...
export type Database = {
  ...
  public: {
    ...
    Views: {
      ...
      daily_email_stats: {
        Row: {
          avg_followup_count: number | null;
          avg_response_time_hours: number | null;
          bounced_count: number | null;
          expired_count: number | null;
          high_followup_count: number | null;
          manual_review_count: number | null;
          max_reached_count: number | null;
      ...
      daily_followup_stats: {
        Row: {
          avg_followup_number: number | null;
    ...
    Functions: {
      ...
      get_bounce_mailbox_id: {
        Args: { p_bounce_id: string };
        Returns: string;
      };
