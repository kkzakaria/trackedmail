...
> = {
  ...
  expired: {
    ...
    variant: "outline",
    className:
      "bg-slate-100 text-slate-800 border-slate-200 dark:bg-slate-900/20 dark:text-slate-300",
  },
...
export function TrackedEmailStatusBadge({
  status,
  className,
}: TrackedEmailStatusBadgeProps) {
